...
#   timestamp: 2026-03-30T19:07:09+00:00
...
class AgentDefinitionCreateRequest(BaseModel):
    ...
    target_hardware: list[str] = Field(..., title='Target Hardware')
    target_languages: list[str] = Field(..., title='Target Languages')
    eval_version: str = Field(..., title='Eval Version')
    docker_image: str = Field(..., title='Docker Image')
    agent_class: str = Field(..., title='Agent Class')
    agent_config: dict[str, Any] = Field(..., title='Agent Config')
    tools_config: dict[str, Any] = Field(..., title='Tools Config')
...
class AgentDefinitionDetail(BaseModel):
    ...
    archived_at: datetime | None = Field(..., title='Archived At')
    agent_config: dict[str, Any] = Field(..., title='Agent Config')
    tools_config: dict[str, Any] = Field(..., title='Tools Config')


class AgentDefinitionRouteCreateRequest(BaseModel):
    hardware: str = Field(..., title='Hardware')
    language: str = Field(..., title='Language')
    agent_definition_id: UUID = Field(..., title='Agent Definition Id')
    priority: int | None = Field(0, title='Priority')
    is_default: bool | None = Field(False, title='Is Default')
    email_domains: list[str] | None = Field([], title='Email Domains')
    user_ids: list[UUID] | None = Field([], title='User Ids')


class AgentDefinitionRouteSetDefaultRequest(BaseModel):
    route_id: UUID = Field(..., title='Route Id')


class AgentDefinitionRouteUpdateRequest(BaseModel):
    agent_definition_id: UUID = Field(..., title='Agent Definition Id')
    priority: int | None = Field(0, title='Priority')
    is_default: bool | None = Field(False, title='Is Default')
...
class AvailableAgentDefinitionResponse(BaseModel):
    hardware: str = Field(..., title='Hardware')
    language: str = Field(..., title='Language')
    name: str = Field(..., title='Name')
    agent_definition_id: UUID = Field(..., title='Agent Definition Id')
...
class CommandOut(BaseModel):
    ...
    attempt_run_id: UUID | None = Field(..., title='Attempt Run Id')
...
class EvaluateKernelRequest(BaseModel):
    ...
    ref_modes: list[EvalRefMode] | None = Field(None, title='Ref Modes')
...
class KernelProfile(BaseModel):
    ...
    torch_key_averages: dict[str, list[str]] | None = Field(
        None, title='Torch Key Averages'
    )
...
class ListResultAgentDefinitionSummary(BaseModel):
    items: list[AgentDefinitionSummary] = Field(..., title='Items')
    total: int = Field(..., title='Total')
    limit: int | None = Field(None, title='Limit')
    offset: int | None = Field(0, title='Offset')
...
class OfferParamsWrapperInput(BaseModel):
    params: FreeCreditsForNewUsersOfferParamsInput | None = Field(..., title='Params')


class OfferParamsWrapperOutput(BaseModel):
...
class OfferParticipationRequest(BaseModel):
    participant_id: UUID = Field(..., title='Participant Id')
...
class Permission(Enum):
    ...
    view_full_leaderboard = 'view_full_leaderboard'
    hardware_access_rules_view = 'hardware_access_rules.view'
    offers_manage = 'offers.manage'
    offers_view = 'offers.view'
    custom_solution_submit = 'custom_solution.submit'
    hardware_access_rules_manage = 'hardware_access_rules.manage'
    billing_bills_view_any_user_bills = 'billing.bills.view_any_user_bills'
    billing_billing_rules_view = 'billing.billing_rules.view'
    billing_billing_rules_manage = 'billing.billing_rules.manage'
    users_view_all_users = 'users.view_all_users'
    users_view_any_user_details = 'users.view_any_user_details'
    agent_session_kernel_view_generation_details = (
        'agent_session.kernel.view_generation_details'
    )
    agent_session_attempt_view_logs = 'agent_session.attempt.view_logs'
    agent_session_attempt_view_command_logs = 'agent_session.attempt.view_command_logs'
    view_all_generation_sessions = 'view_all_generation_sessions'
    manage_all_generation_sessions = 'manage_all_generation_sessions'
    view_own_generation_sessions = 'view_own_generation_sessions'
    agent_definition_view_all = 'agent_definition.view_all'
    agent_definition_manage_own = 'agent_definition.manage_own'
    agent_definition_manage_all = 'agent_definition.manage_all'
    agent_definition_route_view = 'agent_definition.route.view'
    agent_definition_route_manage = 'agent_definition.route.manage'
    agent_definition_use_all = 'agent_definition.use_all'
...
class SessionAgentDefinitionResponse(BaseModel):
    id: UUID = Field(..., title='Id')
    session_id: UUID = Field(..., title='Session Id')
    agent_definition_id: UUID = Field(..., title='Agent Definition Id')
    name: str = Field(..., title='Name')
...
class SiteSettings(BaseModel):
    ...
    request_more_credits_survey_id: str = Field(
        ..., title='Request More Credits Survey Id'
    )
...
class UpdateOffer(BaseModel):
    ...
    details: OfferParamsWrapperInput | None
...
class AgentDefinitionRouteResponse(BaseModel):
    id: UUID = Field(..., title='Id')
    hardware: str = Field(..., title='Hardware')
    language: str = Field(..., title='Language')
    agent_definition_id: UUID = Field(..., title='Agent Definition Id')
    ...
    user_ids: list[UUID] = Field(..., title='User Ids')
    created_at: datetime = Field(..., title='Created At')
    updated_at: datetime = Field(..., title='Updated At')
...
class KernelGenerationRequest(BaseModel):
    ...
    agent_definition_id: UUID | None = Field(None, title='Agent Definition Id')
...
class OfferParticipation(BaseModel):
    id: UUID | None = Field(None, title='Id')
    participant_id: UUID = Field(..., title='Participant Id')
    offer_id: UUID = Field(..., title='Offer Id')
    offer_type: OfferType
    offer_name: str = Field(..., title='Offer Name')
    offer_params: OfferParamsWrapperOutput | None
    created_at: datetime | None = Field(None, title='Created At')


class OfferParticipationOut(BaseModel):
    id: UUID = Field(..., title='Id')
    participant_id: UUID = Field(..., title='Participant Id')
    offer_id: UUID = Field(..., title='Offer Id')
    offer_type: OfferType
    offer_name: str = Field(..., title='Offer Name')
    created_at: datetime = Field(..., title='Created At')
    user_full_name: str = Field(..., title='User Full Name')
...
class ListResultOfferParticipationOut(BaseModel):
    items: list[OfferParticipationOut] = Field(..., title='Items')
    total: int = Field(..., title='Total')
    limit: int | None = Field(None, title='Limit')
    offset: int | None = Field(0, title='Offset')
...
class KernelEvaluationDetails(BaseModel):
    ...
    profiling_run: KernelProfilingRun | None
